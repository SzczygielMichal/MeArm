...
//
//	Dodane przeze mnie do testowania parametr�w podczas podawania komend przez konsol�
//
        i = 0;
        j = 0;
        temp_m = 0;
...
//
//	Koniec dodane przeze mnie do testowania parametr�w podczas podawania komend przez konsol�
//
